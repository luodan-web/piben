	...
	<view class="container">
		...
		<view class="wrapper">
			...
			<view class="input-content">
				<view class="input-item"  v-if="event == 'resetpwd'">
					<text class="tit">固定手机</text>
					<input 
						type="text" 
						:value="phone" 
						placeholder="请输入固定手机"
	...
	export default{
		...
		methods: {
			...
			async getCaptcha(){
				...
				let data = await this.$api.request('/index/resetpwd', 'POST', {
					mobile: this.mobile,
					event: this.register,
				});
				if (data) {
			...
			async toLogin(){
				...
				let url = this.event == 'register' ? '/index/register' : '/index/resetpwd';
